...
router.post('/register', async(req, res)=>{
  ...
  try{
    ...
    //     }
    //     res.status(200).json({ message: 'Signup succe ssful! Please check your email for confirmation.', messageType: 'success' });
    //   });

    res.status(200).json({ message: 'Signup successful!.', messageType: 'success' });
